    ...
    if (method === 'poolish') {
      if (fermentationType === 'room') {
        ...
        timeline.push(
          ...
          { time: prep, task: 'Prep & preheat Ooni', desc: 'Prepare toppings, heat Ooni to 850°F. Dough should be airy and extensible.' },
        ...
        timeline.push(
          ...
          { time: prep, task: 'Prep & preheat Ooni', desc: 'Prepare toppings, heat Ooni to 850°F.' },
      ...
      if (fermentationType === 'room') {
        ...
        timeline.push(
          ...
          { time: prep, task: 'Prep & preheat Ooni', desc: 'Dough should be airy and domed. Heat Ooni to 850°F.' },
        ...
        timeline.push(
          ...
          { time: prep, task: 'Prep & preheat Ooni', desc: 'Heat Ooni to 850°F.' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 p-4">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8 pt-6">
          ...
          <p className="text-gray-600">Ooni Pizza Calculator</p>
        </div>
        ...
        {step === 4 && recipe && (
          <div className="space-y-6">
            <div className="bg-white rounded-3xl shadow-xl p-8">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Your Recipe</h2>
              {method === 'poolish' ? (
                <>
            ...
            <div className="flex gap-3">
              ...
              <button onClick={() => setStep(1)} className="flex-1 bg-red-600 text-white py-4 rounded-2xl font-semibold text-lg hover:bg-red-700 transition-colors">New Recipe</button>
            </div>
          </div>
        )}
      </div>
